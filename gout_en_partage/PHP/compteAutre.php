...
if (mysqli_connect_errno()) {
  ...
  session_start();
  $CurentPseudoAutre = $_SESSION["currentPseudoAutre"];
  if (isset($_SESSION["pseudo"])){
    ...
    $result_Liste = mysqli_query($connexion, "Select distinct Liste.idListe, pp, Liste.pseudo, Liste.nom as titreListe, estPublic FROM Liste JOIN Compte ON Liste.pseudo = Compte.pseudo Having (estPublic = 1 and Liste.pseudo = '$CurentPseudoAutre')");
    ...
    //Pareil avec le fichier accueil.php 
    echo '<div class = "divListeAside">';

    //Affichage pour user Connecter
    if($result_Liste && isset($_SESSION["pseudo"]) && $_SESSION["pseudo"] != " "){
